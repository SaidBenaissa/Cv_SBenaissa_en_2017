...
\begin{document}
\href{http://www.univh2m.ac.ma}{\makeheading{Dr.~Said~Benaissa}}
...
%Assistant Professor\\
\href{http://www.univh2m.ac.ma}{Hassan II University, Casablanca}\\

\href{http://www.ensem.ac.ma}{National High School Of Electricity And Mechanics}\\
Casablanca\\
Morocco
}
...
\parbox{\rcollength}{%
\textit{Mobile:} +212 -688-463-485\\ %+212 -638-410-026 \\
%\textit{Fax:} +212 -638-410-026 \\
\textit{E-mail:} \email{d.sbenaissa@gmail.com}\\
\textit{Web:} \href{http://saidbenaissa.netai.net}{http://saidbenaissa.netai.net}}
...
%%%            \href{http://www.asu.edu/}{Hassan II University}
...
\textbf{PhD in Computer Science},
        \href{http://humancomputation.org/}{Hassan II University}
        \hfill {December 2016 to present}
...
%%%            \href{http://www.osu.edu/}{Hassan II University Casablanca}
...
\section{Education}
%\href{http://www.univh2m.ac.ma/}{\textbf{National High School of Electricity and Mechanics, Hassan II University }},
%Casablanca
\begin{outerlist}
\item[] Ph.D.\href{http://www.univh2m.ac.ma/}{National High School of Electricity and Mechanics, Hassan II University},
Casablanca.
        \href{http://saidbenaissa.netai.net}
             {Computer Science Engineering},
             December 2016
        \begin{innerlist}
        \item Thesis Topic: \emph{Design and Development of a Mobile Robot Control Platform: Simultaneous Localization and Cartography}
        \item Thesis Proposal: \emph{Cooperative Task Processing}
        \item Candidacy: \emph{Research Problems in Distributed Control Systems}
        \item Adviser:
              \href{http://www.ensem.ac.ma}
                   {Professor H.Medromi}
        \item Area of Study: Control Engineering
        \end{innerlist}

\item[] M.S.Cadi Ayyad University - Faculty of Sciences and Technics.
        \href{http://www.fstg-marrakech.ac.ma/}
             {Networking and Telecommunications Engineering}, August 2008
        \begin{innerlist}
        \item Thesis Topic: \emph{Evaluation of the performance of IP Networks: Study, Comparison and Simulation of the queue management algorithms .}
        \item Adviser:
              \href{http://www.ensa.ac.ma/}
                   {Professor N.Idboufker}
        \item Area of Study: Control Engineering
        \end{innerlist}

\item[] B.S.\href{http://www.fssm.uca.ma/} {Physics Engineering}, June 2005,
...
\end{outerlist}
 ...
 \begin{bibenum}
    \item Said Benaissa. Robotics Operating System: Mobile Robot Localization Methodology. \emph{International Journal of Advanced Robotic Systems}, March 26 2017.
%        \doi{10.1007/s11721-014-0100-8}
%Robotics Operating System: Mobile Robot Localization Methodology
...
%
%\begin{bibenum}
%    \item S.Benaissa. Robotics Operating System: Mobile Robot Localization Methodology.
%     \emph{Swarm Intelligence}, 8(4):303--327, December 2014.
%        \doi{10.1007/s11721-014-0100-8}
%
%\end{bibenum}
...
\begin{bibenum}
    ...
    \item S.Benaissa, F.Moutaouakkil,  S.Tallal, H.Medromi .Modelization and Implementation of EKF-Localization for Mobile Robot using ROS.
        In: \emph{The 13th International Conference on Informatics in Control, Automation and Robotics, At Portugal, Lisbon.~(ICINCO ~13)},
        July 29~-- July 31 2016.\\
        \doi{10.13140/RG.2.1.4676.8880}

  \item M.Salim Lmimouni, S.Benaissa, H.Medromi, A.Sayouti, Using an MPI Cluster in the Control of a Mobile Robots System by 
     \emph{International Journal of Advanced Computer Science \& Applications ~ (IJACSA~2014)} \\

    \item  M. El Bakkali, S. Benaissa, S. Tallal, A. Sayouti, H. Medromi, "EAAS3" Distributed Control Architecture of MAS Robotic Systems.
    \emph{International Review on Computers and Software ~(IRECOS~2013)}.\\

    \item S.Benaissa, M.El Bakkali and H.Medromi, Agent Communication protocols for Autonomous mobile robots.
        \emph{International Journal on Communications Antenna and Propagation~(IRECAP~2012)}.\\
%        April 8--11, 2013. \doi{10.1145/2461328.2461349}
%%%
    \item  S.Benaissa, F. Moutaouakkil, H.Medromi, New Multi-Agent's Control Architecture for the Autonomous Mobile Robots.
    ~\emph{International Review on Computers and Software~(IRECOS~2011)}.\\

    \item S.Benaissa, S.Tallal and H.Medromi, Autonomous mobile robots
    ~\emph{International Journal of Emerging Trends \& Technology in Computer Science~(IJETTCS~2012}.
...
%\newpage
%\cvsubsection{Communications Internationales}
%\begin{cvhonors}
%%  \cvhonor
%%    {ICINCO 2016}
%%    {Modelization and Implementation of EKF-Localization for Mobile Robot using ROS}
%%    {Lisbon, Portugal}
%%    {July 2016}
%\cvhonor
%    {ICINCO 2016}
%    {Modelization and Implementation of EKF-Localization for Mobile Robot using ROS, 13th International Conference on Informatics in Control, Automation and Robotics, Lisbonne 29-31 Juillet, Said Benaissa, Fouad Moutaouakil, Hicham Medromi, Saadia Tallal,}
%    {}
%    {2016.}
%\\
%  \cvhonor
%    {WOTIC 2010}
%    {Novel Approch for Developing a Robotic System Based on Multi-Agent. by F. Moutaouakkil, S.Benaissa and H.Medromi}
%    {Casablanca, Maroc}
%    {2011}
%%  \cvhonor
%%    {Silver Prize}
...
%
\begin{innerlist}
    \item Swift, C, C$+$$+$, Java, JavaScript, NetLogo, Pascal, Perl, PHP,
...
\url{http://saidbenaissa.netai.net}.
